  ...
  HOSTEL_WARDEN: {
    ...
    panels: [
      ...
      },
      {
        ...
        span: 12,
        items: [
          { label: "Mark Night Attendance", icon: ClipboardCheck, href: "/hostel-warden/attendance", primary: true },
          { label: "Allot Room", icon: BedDouble, href: "/hostel-warden/manage" },
          { label: "Approve Leave", icon: CalendarClock, href: "/hostel-warden/leaves" },
          { label: "Resolve Complaint", icon: ShieldAlert, href: "/hostel-warden/complaints" },
        ],
      },
    ],
  },
